...
export const createStakeholderSchema = z.object({
  ...
  organizationLevel: z.nativeEnum(StakeholderLevel, { message: 'Nível organizacional inválido' }).optional(),
  position:          z.nativeEnum(StakeholderPosition, { message: 'Posição inválida' }),
